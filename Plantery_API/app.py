...
app.config['MAIL_USERNAME'] = '3155c6cfe44f91'
app.config['MAIL_PASSWORD'] = 'ae3b0654f73415'
...
def db_seed():
    ...
    earth = Planet(planet_name='Venus',
                   planet_type='Class M',
                   home_star='Sol',
                   mass=5.972e24,
                   radius=3959,
    ...
    test_user = User(first_name='Mohit',
                     last_name='Rikhi',
                     email='test@test.com',
                     password='Test@1234r')
...
@app.route('/not_found')
def not_found():
    return jsonify(message='That resource is not available'), 400
...
def parameters():
    ...
    if age < 18:
        ...
        return jsonify(message="Welcome " + name + ", your are old enough!")
